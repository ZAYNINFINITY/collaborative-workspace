...
const MONGO_URI =
  "mongodb+srv://zaynbu269_db_user:1999@cluster0.rdbierg.mongodb.net/collabWorkspace?retryWrites=true&w=majority";
...
async function fixDatabase() {
  try {
    ...
    console.log(
      "📝 Indexes will be recreated automatically when models are loaded",
    );
