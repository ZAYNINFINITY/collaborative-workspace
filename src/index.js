  ...
  styles: {
    global: {
      body: {
        ...
        // The mesh gradient is applied in index.css
      },
    },
  },
  fonts: {
      ...
      variants: {
        solid: (props) => ({
          ...
          _hover: {
            ...
            boxShadow: props.colorScheme === "blue" ? "var(--chakra-shadows-neonBlue)" : undefined,
        ...
        outline: {
          field: {
            ...
            _focus: {
              ...
              boxShadow: "0 0 0 1px var(--chakra-colors-cyan-400), var(--chakra-shadows-neonBlue)",
              bg: "whiteAlpha.100",
            }
          }
        }
